...
def unity_reply(plugin_event, Proc):
    ...
    if flag_is_command:
        ...
        if not flag_groupEnable and not flag_force_reply:
            return
        if isMatchWordStart(tmp_reast_str, 'log', isCommand=True):
            tmp_reast_str = getMatchWordStartRight(tmp_reast_str, 'log')
            tmp_reast_str = skipSpaceStart(tmp_reast_str)
            tmp_reply_str = None
            flag_log_private_ok = False
            # log stop/code/id 无视锁定状态，直接执行
            if flag_is_from_group and not isMatchWordStart(tmp_reast_str, ['stop', 'halt', 'code', 'id']):
                ...
                if log_ending_lock:
                    ...
                    tmp_reply_str = OlivaDiceCore.msgCustomManager.formatReplySTR(
                        dictStrCustom['strLoggerLogEndingInProgress'], dictTValue
                    )
                    replyMsg(plugin_event, tmp_reply_str)
                    return

            if isMatchWordStart(tmp_reast_str, 'upload'):
                flag_log_private_ok = True
                tmp_reast_str = getMatchWordStartRight(tmp_reast_str, 'upload')
                tmp_reast_str = skipSpaceStart(tmp_reast_str)

                if not tmp_reast_str.strip():
                    tmp_reply_str = OlivaDiceCore.msgCustomManager.formatReplySTR(
                        dictStrCustom['strLoggerLogUploadNoName'], dictTValue
                    )
                    replyMsg(plugin_event, tmp_reply_str)
                    return
                ...
                log_files = [
                    f
                    for f in os.listdir(f'{dataPath}{dataLogPath}')
                ...
                if not log_name:
                    ...
                    tmp_reply_str = OlivaDiceCore.msgCustomManager.formatReplySTR(
                        dictStrCustom['strLoggerLogFileNotFound'], dictTValue
                    )
                    replyMsg(plugin_event, tmp_reply_str)
                    return
                ...
                upload_timeout_seconds = OlivaDiceCore.console.getConsoleSwitchByHash(
                    'logUploadTimeout', plugin_event.bot_info.hash
                )
                ...
                try:
                    ...
                    dictTValue['tLogUUID'] = log_uuid
                    tmp_reply_str = OlivaDiceCore.msgCustomManager.formatReplySTR(
                        dictStrCustom['strLoggerLogUploadFailed'], dictTValue
                    )
                    replyMsg(plugin_event, tmp_reply_str)
                    traceback.print_exc()
                return
                ...
                if not tmp_reast_str.strip():
                    tmp_reply_str = OlivaDiceCore.msgCustomManager.formatReplySTR(
                        dictStrCustom['strLoggerLogGenerateNoUUID'], dictTValue
                    )
                    replyMsg(plugin_event, tmp_reply_str)
                    return
                ...
                if not log_name:
                    dictTValue['tLogUUID'] = log_uuid
                    tmp_reply_str = OlivaDiceCore.msgCustomManager.formatReplySTR(
                        dictStrCustom['strLoggerLogGenerateNotFound'], dictTValue
                    )
                    replyMsg(plugin_event, tmp_reply_str)
                    return
                ...
                try:
                    ...
                    if success:
                        ...
                        dictTValue['tLogUUID'] = log_uuid
                        tmp_reply_str = OlivaDiceCore.msgCustomManager.formatReplySTR(
                            dictStrCustom['strLoggerLogGenerateSuccess'], dictTValue
                        )
                    else:
                        dictTValue['tLogUUID'] = log_uuid
                ...
                if target_uuid:
                    ...
                    if not log_name:
                        tmp_reply_str = OlivaDiceCore.msgCustomManager.formatReplySTR(
                            dictStrCustom['strLoggerLogStatNotFound'], dictTValue
                        )
                        replyMsg(plugin_event, tmp_reply_str)
                        return
                ...
                if not status_data:
                    ...
                    dictTValue['tLogName'] = log_name
                    tmp_reply_str = OlivaDiceCore.msgCustomManager.formatReplySTR(
                        dictStrCustom['strLoggerLogStatUUIDNotFound'], dictTValue
                    )
                    replyMsg(plugin_event, tmp_reply_str)
                    return
                ...
                if show_all:
                    # 显示所有人的数据
                    stat_text, total_success, total_fail, users_data = OlivaDiceLogger.logger.format_all_stat_data(
                        plugin_event, status_data, dictStrCustom
                    )
                    if not stat_text:
                        dictTValue['tStatData'] = '无数据'
                        tmp_reply_str = OlivaDiceCore.msgCustomManager.formatReplySTR(
                            dictStrCustom['strLoggerLogStatEmpty'], dictTValue
                        )
                    else:
                        ...
                        tmp_reply_str = OlivaDiceCore.msgCustomManager.formatReplySTR(
                            dictStrCustom['strLoggerLogStatAll'], dictTValue
                        )
                    replyMsg(plugin_event, tmp_reply_str)
                elif target_user_id:
                    # 显示指定用户的数据
                    user_hash = OlivaDiceCore.userConfig.getUserHash(
                        target_user_id, 'user', plugin_event.platform['platform']
                    )
                    ...
                    if not user_data:
                        tmp_reply_str = OlivaDiceCore.msgCustomManager.formatReplySTR(
                            dictStrCustom['strLoggerLogStatUserEmpty'], dictTValue
                        )
                    else:
                        stat_text, total_success, total_fail, pc_cards_data = (
                            OlivaDiceLogger.logger.format_user_stat_data(
                        ...
                        if not stat_text:
                            ...
                            if total_success + total_fail > 0:
                                ...
                                dictTValue['tSuccessRate'] = '0.00'
                            tmp_reply_str = OlivaDiceCore.msgCustomManager.formatReplySTR(
                                dictStrCustom['strLoggerLogStatUser'], dictTValue
                            )
                    replyMsg(plugin_event, tmp_reply_str)
                else:
                    # 显示自己的数据
                    user_hash = OlivaDiceCore.userConfig.getUserHash(
                        plugin_event.data.sender['id'], 'user', plugin_event.platform['platform']
                    )
                    user_data = status_data.get(user_hash)

                    if not user_data:
                        tmp_reply_str = OlivaDiceCore.msgCustomManager.formatReplySTR(
                            dictStrCustom['strLoggerLogStatSelfEmpty'], dictTValue
                        )
                    else:
                        stat_text, total_success, total_fail, pc_cards_data = (
                            OlivaDiceLogger.logger.format_user_stat_data(
                ...
                current_group_id = str(plugin_event.data.group_id) if flag_is_from_group else ''
                if flag_log_ended:
                    old_group_hash = None
                    input_group_id = current_group_id
                    ...
                    if matched_platform:
                        ...
                        input_group_id = matched_group_id.strip() or current_group_id
                    else:
                    ...
                    input_group_id = current_group_id
                    input_platform = plugin_event.platform['platform']
                # 私聊生成续接码必须带群号/平台，或使用 end 跳过群校验
                if not flag_is_from_group and not flag_log_ended and input_group_id == '':
                    tmp_reply_str = OlivaDiceCore.msgCustomManager.formatReplySTR(
                        dictStrCustom['strLoggerLogCodeNoUUID'], dictTValue
                    )
                    replyMsg(plugin_event, tmp_reply_str)
                ...
                replyMsg(plugin_event, tmp_reply_str)
                return
            if not flag_is_from_group and not flag_log_private_ok:
                tmp_reply_str = OlivaDiceCore.msgCustomManager.formatReplySTR(
                    dictStrCustom['strForGroupOnly'], dictTValue
                )
                replyMsg(plugin_event, tmp_reply_str)
            ...
            if isMatchWordStart(tmp_reast_str, ['on', 'new']):
                ...
                if is_logging:
                    ...
                    tmp_reply_str = OlivaDiceCore.msgCustomManager.formatReplySTR(
                        dictStrCustom['strLoggerLogAlreadyOn'], dictTValue
                    )
                    replyMsg(plugin_event, tmp_reply_str)
                    return
                ...
                if tmp_reast_str.strip() != '':
                    ...
                    if not OlivaDiceLogger.logger.is_valid_log_name(log_name):
                        dictTValue['tLogName'] = log_name
                        tmp_reply_str = OlivaDiceCore.msgCustomManager.formatReplySTR(
                            dictStrCustom['strLoggerLogInvalidName'], dictTValue
                        )
                        replyMsg(plugin_event, tmp_reply_str)
                        return
                ...
                if log_name not in log_name_list:
                    ...
                    log_name_time_dict[log_name] = {'start_time': time.time(), 'end_time': 0, 'total_time': 0}
                    # 初始化日志状态数据
                    ...
                    tmp_reply_str = OlivaDiceCore.msgCustomManager.formatReplySTR(
                        dictStrCustom['strLoggerLogOn'], dictTValue
                    )
                else:
                    # 继续记录，更新开始时间
                    ...
                    dictTValue['tLogTime'] = formatted_duration
                    tmp_reply_str = OlivaDiceCore.msgCustomManager.formatReplySTR(
                        dictStrCustom['strLoggerLogContinue'], dictTValue
                    )
                ...
                account_type_sync, linked_bot_hashes_sync, relations_dict_sync = getLinkedBotHashes(
                    plugin_event.bot_info.hash
                )
                ...
                if is_continue and last_message_id and log_quote:
                    if plugin_event.platform['platform'] == 'qq' or flag_qqguild_v2:
                        try:
                            # 尝试构造引用回复消息
                            dictTValue['tLogName'] = log_name
                            tmp_reply_str_2 = OlivaDiceCore.msgCustomManager.formatReplySTR(
                                dictStrCustom['strLoggerLogQuote'], dictTValue
                            )
                ...
                if not is_logging:
                    tmp_reply_str = OlivaDiceCore.msgCustomManager.formatReplySTR(
                        dictStrCustom['strLoggerLogAlreadyOff'], dictTValue
                    )
                    replyMsg(plugin_event, tmp_reply_str)
                    return
                ...
                dictTValue['tLogUUID'] = tmp_log_uuid
                tmp_reply_str = OlivaDiceCore.msgCustomManager.formatReplySTR(
                    dictStrCustom['strLoggerLogOff'], dictTValue
                )
                ...
                if log_name is None:
                    ...
                    tmp_reply_str = OlivaDiceCore.msgCustomManager.formatReplySTR(
                        dictStrCustom['strLoggerLogAlreadyEnd'], dictTValue
                    )
                    replyMsg(plugin_event, tmp_reply_str)
                    return
                ...
                if log_name not in log_name_list:
                    ...
                    dictTValue['tLogName'] = log_name
                    tmp_reply_str = OlivaDiceCore.msgCustomManager.formatReplySTR(
                        dictStrCustom['strLoggerLogNotFound'], dictTValue
                    )
                    replyMsg(plugin_event, tmp_reply_str)
                    return
                ...
                dictTValue['tLogUUID'] = tmp_log_uuid
                tmp_reply_str = OlivaDiceCore.msgCustomManager.formatReplySTR(
                    dictStrCustom['strLoggerLogEnd'], dictTValue
                )
                replyMsg(plugin_event, tmp_reply_str)
                ...
                try:
                    if OlivaDiceLogger.logger.releaseLogFile(tmp_logName, total_duration):
                        ...
                        dictTValue['tLogUUID'] = tmp_log_uuid
                        tmp_reply_str = OlivaDiceCore.msgCustomManager.formatReplySTR(
                            dictStrCustom['strLoggerLogSave'], dictTValue
                        )
                        replyMsg(plugin_event, tmp_reply_str)
                        ...
                        try:
                            OlivaDiceLogger.logger.uploadLogFile(tmp_logName, timeout=upload_timeout_seconds)
                            encoded_logName = urllib.parse.quote(tmp_logName)
                            dictTValue['tLogUrl'] = '%s%s' % (OlivaDiceLogger.data.dataLogPainterUrl, encoded_logName)
                            tmp_reply_str = OlivaDiceCore.msgCustomManager.formatReplySTR(
                        ...
                        try:
                            if plugin_event.platform['platform'] == 'kaiheila' and plugin_event.indeAPI.hasAPI(
                                'create_message'
                            ):
                ...
                if len(active_logs) == 0:
                    tmp_reply_str = OlivaDiceCore.msgCustomManager.formatReplySTR(
                        dictStrCustom['strLoggerLogListEmpty'], dictTValue
                    )
                else:
                    active_log_name = OlivaDiceCore.userConfig.getUserConfigByKey(
                        userId=tmp_hagID,
                    ...
                    dictTValue['tLogList'] = '\n'.join(log_list_str)
                    tmp_reply_str = OlivaDiceCore.msgCustomManager.formatReplySTR(
                        dictStrCustom['strLoggerLogList'], dictTValue
                    )
                ...
                if log_ending_lock:
                    ...
                    tmp_reply_str = OlivaDiceCore.msgCustomManager.formatReplySTR(
                        dictStrCustom['strLoggerLogStopUnlock'], dictTValue
                    )
                    replyMsg(plugin_event, tmp_reply_str)
                    return
                ...
                if not log_error:
                    tmp_reply_str = OlivaDiceCore.msgCustomManager.formatReplySTR(
                        dictStrCustom['strLoggerLogStop'], dictTValue
                    )
                else:
                    tmp_reply_str = OlivaDiceCore.msgCustomManager.formatReplySTR(
                        dictStrCustom['strLoggerLogStopError'], dictTValue
                    )
                ...
                if log_name not in log_name_list:
                    dictTValue['tLogName'] = log_name
                    tmp_reply_str = OlivaDiceCore.msgCustomManager.formatReplySTR(
                        dictStrCustom['strLoggerLogNameNotFound'], dictTValue
                    )
                    replyMsg(plugin_event, tmp_reply_str)
                    return
                ...
                if OlivaDiceLogger.logger.releaseLogFile(tmp_logName, total_duration, temp=True):
                    ...
                    try:
                        ...
                        dictTValue['tLogUUID'] = tmp_log_uuid
                        encoded_logName = urllib.parse.quote(tmp_logName)
                        dictTValue['tLogUrl'] = '%s%s_temp' % (OlivaDiceLogger.data.dataLogPainterUrl, encoded_logName)
                        tmp_reply_str = OlivaDiceCore.msgCustomManager.formatReplySTR(
                        ...
                        dictTValue['tLogUUID'] = tmp_log_uuid
                        tmp_reply_str = OlivaDiceCore.msgCustomManager.formatReplySTR(
                            dictStrCustom['strLoggerLogTempFailed'], dictTValue
                        )
                        traceback.print_exc()
                else:
                    dictTValue['tLogName'] = log_name
                ...
                if old_name == new_name:
                    dictTValue['tLogName'] = new_name
                    tmp_reply_str = OlivaDiceCore.msgCustomManager.formatReplySTR(
                        dictStrCustom['strLoggerLogRenameSameName'], dictTValue
                    )
                    replyMsg(plugin_event, tmp_reply_str)
                    return
                ...
                if new_name in log_name_list:
                    dictTValue['tLogName'] = new_name
                    tmp_reply_str = OlivaDiceCore.msgCustomManager.formatReplySTR(
                        dictStrCustom['strLoggerLogRenameNameExists'], dictTValue
                    )
                    replyMsg(plugin_event, tmp_reply_str)
                    return
                ...
                if active_log_name == old_name:
                    tmp_reply_str = OlivaDiceCore.msgCustomManager.formatReplySTR(
                        dictStrCustom['strLoggerLogRenameActiveSuccess'], dictTValue
                    )
                else:
                    tmp_reply_str = OlivaDiceCore.msgCustomManager.formatReplySTR(
                        dictStrCustom['strLoggerLogRenameSuccess'], dictTValue
                    )
                ...
                if log_name in log_name_list:
                    ...
                    dictTValue['tLogName'] = log_name
                    tmp_reply_str = OlivaDiceCore.msgCustomManager.formatReplySTR(
                        dictStrCustom['strLoggerLogActiveSwitch'], dictTValue
                    )
                    replyMsg(plugin_event, tmp_reply_str)
                else:
                    # 如果直接切换失败，尝试模糊搜索
                ...
                if isMatchWordStart(tmp_reast_str, 'on', fullMatch=True):
                    ...
                    if log_quote_enabled:
                        tmp_reply_str = OlivaDiceCore.msgCustomManager.formatReplySTR(
                            dictStrCustom['strLoggerLogQuoteAlreadyOn'], dictTValue
                        )
                    else:
                        OlivaDiceCore.userConfig.setUserConfigByKey(
                            userConfigKey='logQuote',
                        ...
                        tmp_reply_str = OlivaDiceCore.msgCustomManager.formatReplySTR(
                            dictStrCustom['strLoggerLogQuoteOn'], dictTValue
                        )
                    replyMsg(plugin_event, tmp_reply_str)
                    return
                    ...
                    if not log_quote_enabled:
                        tmp_reply_str = OlivaDiceCore.msgCustomManager.formatReplySTR(
                            dictStrCustom['strLoggerLogQuoteAlreadyOff'], dictTValue
                        )
                    else:
                        OlivaDiceCore.userConfig.setUserConfigByKey(
                            userConfigKey='logQuote',
                        ...
                        tmp_reply_str = OlivaDiceCore.msgCustomManager.formatReplySTR(
                            dictStrCustom['strLoggerLogQuoteOff'], dictTValue
                        )
                    replyMsg(plugin_event, tmp_reply_str)
                    return
                else:
                    ...
                    if not tmp_reast_str.strip():
                        ...
                        if not log_name:
                            tmp_reply_str = OlivaDiceCore.msgCustomManager.formatReplySTR(
                                dictStrCustom['strLoggerLogInfoNoLog'], dictTValue
                            )
                            replyMsg(plugin_event, tmp_reply_str)
                            return
                    else:
                ...
                if isMatchWordStart(tmp_reast_str, 'on', fullMatch=True):
                    ...
                    if log_use_pc_name_enabled:
                        tmp_reply_str = OlivaDiceCore.msgCustomManager.formatReplySTR(
                            dictStrCustom['strLoggerLogUsePcNameAlreadyOn'], dictTValue
                        )
                    else:
                        OlivaDiceCore.userConfig.setUserConfigByKey(
                            userConfigKey='logUsePcName',
                        ...
                        tmp_reply_str = OlivaDiceCore.msgCustomManager.formatReplySTR(
                            dictStrCustom['strLoggerLogUsePcNameOn'], dictTValue
                        )
                    replyMsg(plugin_event, tmp_reply_str)
                    return
                elif isMatchWordStart(tmp_reast_str, 'off', fullMatch=True):
                    ...
                    if not log_use_pc_name_enabled:
                        tmp_reply_str = OlivaDiceCore.msgCustomManager.formatReplySTR(
                            dictStrCustom['strLoggerLogUsePcNameAlreadyOff'], dictTValue
                        )
                    else:
                        OlivaDiceCore.userConfig.setUserConfigByKey(
                            userConfigKey='logUsePcName',
                        ...
                        tmp_reply_str = OlivaDiceCore.msgCustomManager.formatReplySTR(
                            dictStrCustom['strLoggerLogUsePcNameOff'], dictTValue
                        )
                    replyMsg(plugin_event, tmp_reply_str)
                    return
                else:
...
def get_log_info(tmp_hagID, plugin_event, dictTValue, dictStrCustom, log_name=None):
    ...
    if log_name is None:
        ...
        if not log_name:
            return OlivaDiceCore.msgCustomManager.formatReplySTR(dictStrCustom['strLoggerLogInfoNoLog'], dictTValue)
    # 检查日志是否存在
    log_name_list = (
        OlivaDiceCore.userConfig.getUserConfigByKey(
            userId=tmp_hagID,
    ...
    if log_name not in log_name_list:
        dictTValue['tLogName'] = log_name
        return OlivaDiceCore.msgCustomManager.formatReplySTR(dictStrCustom['strLoggerLogNameNotFound'], dictTValue)
    # 检查日志是否正在记录
    is_logging = False
    active_log_name = OlivaDiceCore.userConfig.getUserConfigByKey(
        userId=tmp_hagID,
    ...
    dictTValue['tLogLines'] = str(log_lines)
    dictTValue['tLogTime'] = formatted_duration
    return OlivaDiceCore.msgCustomManager.formatReplySTR(dictStrCustom['strLoggerLogInfo'], dictTValue)
